...
<head>
    ...
    <title>Order Status Update - SolarGlow Tech</title>
</head>
                ...
                <table role="presentation" style="width: 100%; max-width: 650px; border-collapse: collapse; background: #ffffff; border-radius: 24px; box-shadow: 0 20px 60px rgba(251, 146, 60, 0.15); overflow: hidden;">
                                ...
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        ...
                                        <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; text-align: right;">
                                            <strong style="color: #1f2937; font-size: 14px;">{{ORDER_NUMBER}}</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
                                        ...
                                        <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; text-align: right;">
                                            <strong style="color: #1f2937; font-size: 14px;">{{FULL_NAME}}</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
                                        ...
                                        <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; text-align: right;">
                                            <strong style="color: #f97316; font-size: 16px;">₦{{TOTAL_AMOUNT}}</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding: 10px 0; text-align: right;">
                                            <strong style="color: #1f2937; font-size: 14px;">{{ITEMS_COUNT}} item(s)</strong>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px 40px; text-align: center;">
                            <a href="{{ORDER_URL}}" style="display: inline-block; background: linear-gradient(135deg, #f97316 0%, #fb923c 50%, #fbbf24 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 16px; font-size: 16px; font-weight: 700; box-shadow: 0 10px 30px rgba(251, 146, 60, 0.4); transition: all 0.3s ease;">
                                📦 Track Your Order2
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); padding: 40px; text-align: center;">
                            <p style="margin: 0 0 15px 0; color: #d1d5db; font-size: 14px;">
                                <strong style="color: #ffffff;">SolarGlow Tech</strong><br>
                                Nigeria's #1 Solar Energy Solutions Provider
                            </p>
                            
                            <p style="margin: 0 0 15px 0; color: #9ca3af; font-size: 13px; line-height: 1.6;">
                                📧 support@solarglow.com | 📞 +234 800 SOLAR-GO<br>
                                📍 Lagos, Nigeria
                            </p>
                            
                            <div style="border-top: 1px solid rgba(255, 255, 255, 0.1); padding-top: 20px; margin-top: 20px;">
                                <p style="margin: 0 0 10px 0; color: #6b7280; font-size: 12px;">
                                    © 2024 SolarGlow Tech. All rights reserved.
                                </p>
                                <p style="margin: 0; font-size: 11px;">
                                    <a href="#" style="color: #fb923c; text-decoration: none; margin: 0 8px;">Track Order</a>
                                    <span style="color: #4b5563;">|</span>
                                    <a href="#" style="color: #fb923c; text-decoration: none; margin: 0 8px;">Contact Support</a>
                                    <span style="color: #4b5563;">|</span>
